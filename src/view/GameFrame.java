...
public class GameFrame
{
	...
	public GameFrame()
	{
		...
		gameFrame.getContentPane().add(viewPanel);
		gameFrame.getContentPane().add(operatePanel);
	...
	private JPanel getOperatePanel()
	{
		...
		mapWidthPanel.setBounds(0, 70, 360, 57);
		...
		mapLengthPanel.setBounds(0, 137, 360, 57);
		...
		multipyCountPanel.setBounds(0, 204, 360, 57);
		...
		multipyCycPanel.setBounds(0, 271, 360, 57);
		JLabel multipyCycLabel=new JLabel("繁殖周期(s)：");
		multipyCycField=new JTextField(20);
		...
		changeButton.setBounds(0, 338, 360, 57);
		...
		reStartButton.setBounds(0, 405, 360, 57);
		...
		startButton.setBounds(0, 472, 360, 57);
		...
		stopButton.setBounds(0, 539, 360, 57);
		...
		spaceLabel.setBounds(0, 3, 360, 57);
